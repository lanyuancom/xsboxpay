 ...
 */
package vip.xiaonuo.pay.modular.payway.enums;
...
public enum PayWayExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        PayWayExceptionEnum(Integer code, String message) {
        this.code = code;
