 ...
 */
package vip.xiaonuo.pay.modular.unifiedorder.enums;
...
public enum UnifiedOrderExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        UnifiedOrderExceptionEnum(Integer code, String message) {
        this.code = code;
