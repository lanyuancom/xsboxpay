 ...
 */
package vip.xiaonuo.pay.modular.payappinfo.enums;
...
public enum PayAppInfoExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        PayAppInfoExceptionEnum(Integer code, String message) {
        this.code = code;
