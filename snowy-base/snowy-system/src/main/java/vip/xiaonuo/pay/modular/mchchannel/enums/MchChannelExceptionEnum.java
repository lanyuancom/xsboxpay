 ...
 */
package vip.xiaonuo.pay.modular.mchchannel.enums;
...
public enum MchChannelExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        MchChannelExceptionEnum(Integer code, String message) {
        this.code = code;
