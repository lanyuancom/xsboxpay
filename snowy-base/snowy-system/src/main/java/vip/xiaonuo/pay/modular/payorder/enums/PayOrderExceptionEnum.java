 ...
 */
package vip.xiaonuo.pay.modular.payorder.enums;
...
public enum PayOrderExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        PayOrderExceptionEnum(Integer code, String message) {
        this.code = code;
