 ...
 */
package vip.xiaonuo.pay.modular.paylog.enums;
...
public enum PayLogExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        PayLogExceptionEnum(Integer code, String message) {
        this.code = code;
