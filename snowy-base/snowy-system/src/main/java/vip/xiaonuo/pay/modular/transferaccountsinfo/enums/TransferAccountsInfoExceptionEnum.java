 ...
 */
package vip.xiaonuo.pay.modular.transferaccountsinfo.enums;
...
public enum TransferAccountsInfoExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        TransferAccountsInfoExceptionEnum(Integer code, String message) {
        this.code = code;
