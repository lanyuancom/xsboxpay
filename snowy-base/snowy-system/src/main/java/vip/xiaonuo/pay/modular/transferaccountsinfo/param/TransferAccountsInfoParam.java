 ...
 */
package vip.xiaonuo.pay.modular.transferaccountsinfo.param;
...
*/
@Data
public class TransferAccountsInfoParam extends BaseParam {
     ...
     * 标签
     */
    @NotBlank(message = "标签不能为空，请检查tags参数", groups = {add.class, edit.class})
    private String tags;
     ...
     * 应用状态: （字典 0正常 1停用 2删除）
     */
    @NotNull(message = "应用状态: （字典 0正常 1停用 2删除）不能为空，请检查status参数", groups = {add.class, edit.class})
