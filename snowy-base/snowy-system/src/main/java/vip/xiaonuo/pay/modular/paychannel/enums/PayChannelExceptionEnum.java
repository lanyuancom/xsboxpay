 ...
 */
package vip.xiaonuo.pay.modular.paychannel.enums;
...
public enum PayChannelExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        PayChannelExceptionEnum(Integer code, String message) {
        this.code = code;
