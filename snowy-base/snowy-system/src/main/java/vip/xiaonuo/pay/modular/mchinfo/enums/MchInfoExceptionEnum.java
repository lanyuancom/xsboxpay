 ...
 */
package vip.xiaonuo.pay.modular.mchinfo.enums;
...
public enum MchInfoExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        MchInfoExceptionEnum(Integer code, String message) {
        this.code = code;
