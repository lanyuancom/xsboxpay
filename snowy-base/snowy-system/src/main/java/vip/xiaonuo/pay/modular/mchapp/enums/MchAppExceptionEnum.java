 ...
 */
package vip.xiaonuo.pay.modular.mchapp.enums;
...
public enum MchAppExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        MchAppExceptionEnum(Integer code, String message) {
        this.code = code;
