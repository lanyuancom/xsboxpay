 ...
 */
package vip.xiaonuo.pay.modular.ordernotifyinfo.enums;
...
public enum OrderNotifyInfoExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        OrderNotifyInfoExceptionEnum(Integer code, String message) {
        this.code = code;
