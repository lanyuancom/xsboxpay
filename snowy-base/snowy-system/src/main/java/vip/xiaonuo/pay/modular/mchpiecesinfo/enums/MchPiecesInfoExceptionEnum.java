 ...
 */
package vip.xiaonuo.pay.modular.mchpiecesinfo.enums;
...
public enum MchPiecesInfoExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        MchPiecesInfoExceptionEnum(Integer code, String message) {
        this.code = code;
