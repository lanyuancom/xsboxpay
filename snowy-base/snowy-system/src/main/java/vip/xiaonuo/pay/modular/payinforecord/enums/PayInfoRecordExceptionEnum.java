 ...
 */
package vip.xiaonuo.pay.modular.payinforecord.enums;
...
public enum PayInfoRecordExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        PayInfoRecordExceptionEnum(Integer code, String message) {
        this.code = code;
